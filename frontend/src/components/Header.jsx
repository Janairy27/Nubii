...
export default function Header({}) {
  ...
  const [anchorElSintomas, setAnchorElSintomas] = useState(null);
  ...
  const submenuData = {
    sintomas: [
      { text: "Registrar Síntomas", path: "/sintomas" },
      { text: "Ver Historial", path: "/listado-sintomas" },
    ],
    reportes: [
