...
export default function RegistroActSug() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post("http://localhost:4000/api/actividades/registro-actividad", formData,
      {
                ...
                <Box component="form" onSubmit={handleSubmit} display="flex" flexDirection="column" gap={3}>
                      ...
                      <Box display="flex" alignItems="center" gap={1} mb={2}>
                        ...
                        <Typography variant="h6" fontWeight="bold"
                          sx={{
                            ...
                            Información del Profesional</Typography>
                      </Box>
                      <TextField label="Profesional" value={nombre} disabled fullWidth
                        sx={{
                  ...
                  <Card variant="outlined" sx={{
                    ...
                    <CardContent>
                      <Box display="flex" alignItems="center" gap={1} mb={2}>
                        ...
                        <Typography variant="h6" fontWeight="bold"
                          sx={{
                            ...
                            Información de la Actividad</Typography>
                      </Box>
                      <TextField 
                      //required
                       fullWidth label="Nombre de la actividad" value={nombreAct}
                      ...
                      <TextField 
                      //required 
                      fullWidth multiline rows={3} label="Descripción" value={descripcion}
                  ...
                  <Card variant="outlined" sx={{
                    ...
                    <CardContent>
                      ...
                      <Typography sx={{
                        ...
                        Tipo de Actividad</Typography>
                      <Box display="flex" flexWrap="wrap" gap={2}>
                        {[
                          { text: "Respiración guiada", icon: <AirIcon fontSize="large" />, value: 1, color: "#4caf50" },
                          { text: "Relajación", icon: <SelfImprovementIcon fontSize="large" />, value: 2, color: "#2196f3" },
                          { text: "Movimiento físico suave", icon: <DirectionsRunIcon fontSize="large" />, value: 3, color: "#ff9800" },
                          { text: "Aire libre", icon: <ParkIcon fontSize="large" />, value: 4, color: "#009688" },
                          { text: "Actividad física activa", icon: <FitnessCenterIcon fontSize="large" />, value: 5, color: "#9c27b0" },
                          { text: "Desahogo emocional", icon: <SentimentSatisfiedAltIcon fontSize="large" />, value: 6, color: "#e91e63" },
                          { text: "Actividad creativa", icon: <BrushIcon fontSize="large" />, value: 7, color: "#ff5722" },
                          { text: "Social", icon: <GroupIcon fontSize="large" />, value: 8, color: "#03a9f4" },
                          { text: "Organización", icon: <ChecklistIcon fontSize="large" />, value: 9, color: "#607d8b" },
                          { text: "Descanso", icon: <BedtimeIcon fontSize="large" />, value: 10, color: "#795548" },
                          { text: "Estimulación cognitiva", icon: <PsychologyIcon fontSize="large" />, value: 11, color: "#673ab7" },
                          { text: "Visualización positiva", icon: <WbSunnyIcon fontSize="large" />, value: 12, color: "#ffc107" },
                        ].map((item) => (
                          <Button
                            key={item.value}
                            onClick={() => setTipo(item.value)}
                            variant={tipo === item.value ? "contained" : "outlined"}
                            sx={{
                              cursor: "pointer",
                              borderRadius: 3,
                              textTransform: "none",
                              ...
                              gap: 1,
                              backgroundColor: tipo === item.value ? item.color : "#f0f0f0",
                              color: tipo === item.value ? "white" : item.color,
                              borderColor: item.color,
                              boxShadow: tipo === item.value
                      ...
                      {/* Nivel */}
                      <Typography sx={{
                        mt: 2, mb: 1, fontWeight: 600,
                        background: " #2D5D7B",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",}}>
                          Nivel de Dificultad</Typography>
                      <Box display="flex" flexWrap="wrap" gap={2}>
                        {[
                          { text: "Muy baja", icon: <SignalCellular1BarIcon />, value: 1, gradient: " #56ab2f" },
                          { text: "Baja", icon: <SignalCellular2BarIcon />, value: 2, gradient: " #ffcc33" },
                          { text: "Media", icon: <SignalCellular3BarIcon />, value: 3, gradient: " #8e24aa" },
                          { text: "Alta", icon: <SignalCellular4BarIcon />, value: 4, gradient: " #c51162" },
                        ].map((item) => (
                          <Box
                            key={item.value}
                            ...
                            sx={{
                              ...
                              justifyContent: "center",
                              fontWeight: "bold",
                              color: nivelDificultad === item.value ? "white" : "#333",
                              background: nivelDificultad === item.value ? item.gradient : "#f0f0f0",
                              boxShadow: nivelDificultad === item.value ? "0 4px 12px rgba(0,0,0,0.25)" : "0 2px 6px rgba(0,0,0,0.1)",
                              transition: "all 0.3s ease",
                              "&:hover": {
                                transform: "translateY(-3px)",
                                boxShadow: "0 6px 16px rgba(0,0,0,0.2)",
                      ...
                      <Box display="flex" flexWrap="wrap" gap={1}>
                        {[
                          ...
                          { text: "Publicar", icon: <PublicIcon />, value: 2, color: "#43a047" },
                        ].map((item) => (
                          <Button
                            key={item.value}
                            startIcon={item.icon}
                            variant={publico === item.value ? "contained" : "outlined"}
                            ...
                            sx={{
                              ...
                              justifyContent: "center",
                              gap: 1,
                              backgroundColor: publico === item.value ? item.color : "transparent",
                              color: publico === item.value ? "white" : item.color,
                              borderColor: item.color,
                              boxShadow: publico === item.value
                                ? "0 4px 12px rgba(0,0,0,0.25)"
                                : "0 2px 6px rgba(0,0,0,0.1)",
                              transition: "all 0.3s ease",
                              "&:hover": {
                                transform: "translateY(-3px)",
                                backgroundColor: publico === item.value ? item.color : `${item.color}22`,
                              },
                            }}
                          >
                            {item.text}
                  ...
                  <Card variant="outlined" sx={{
                    ...
                    <CardContent>
                      ...
                      <TextField
                       //required 
                       fullWidth multiline rows={2} label="Objetivo terapéutico"
                      ...
                      <Typography sx={{
                        mb: 1, fontWeight: 600, textTransform: "capitalize",
                        background: " #2D5D7B",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
                      }}>Archivo multimedia (opcional)</Typography>
                      <Button
                        variant="outlined"
                        component="label"
                        startIcon={<LinkIcon />}
                      ...
                      {multimedia && (
                        <Box sx={{ mt: 2 }}>
                          {multimedia.type.startsWith("image/") ? (
                            ...
                            <Typography variant="body2" sx={{ color: "#2D5D7B" }}>
