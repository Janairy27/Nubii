...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/registroEvidencia/:idActividad"
        element={
          <ProtectedRoute allowedRoles={["3"]}>
            <RegistroEvidencia />{" "}
          </ProtectedRoute>
      ...
      <Route
        path="/listado-recomendaciones"
        element={
          <ProtectedRoute allowedRoles={["3"]}>
            <ActividadPersonalizadaPac />
          </ProtectedRoute>
        }
      />
      <Route
        path="/reporte-emocional"
        element={
          <ProtectedRoute allowedRoles={["3"]}>
            <ReporteEmocional />{" "}
          </ProtectedRoute>
      ...
      />
      <Route
        path="/generar-reporte-emocional"
        element={
          <ProtectedRoute allowedRoles={["2"]}>
      ...
      />
      <Route
        path="/generar-reporte-diagnostico"
        element={<ReporteDiagnosticoProf />}
      />
      <Route
        path="/generar-reporte-seguimiento"
        element={<ReporteSeguimientoProf />}
      />
      ...
      />
      <Route
        path="/reporte-citas-profesional"
        element={
          <ProtectedRoute allowedRoles={["1"]}>
            <ReporteCitaAdm />
          </ProtectedRoute>
      ...
      <Route
        path="/reporte-profesionales-agendados"
        element={<ReporteProfAgendados />}
      />
      <Route path="/respaldo-restauracion" element={<RespaldoRestauracion />} />
      <Route
        path="/listado-sintomaAd"
        element={
          <ProtectedRoute allowedRoles={["1"]}>
            <ListadoSintomasAdmin />{" "}
          </ProtectedRoute>
        }
      />
      <Route
