  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fontSize(18)
        .text("Reporte de Diagnósticos del Paciente", 0, headerY - 5, {
          align: "center",
        });
      ...
      if (grafico) {
        try {
          ...
          doc
            ...
            .text("Distribución y Promedios de Test Aplicados", {
              align: "center",
            });
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        .fontSize(11)
        .font("Helvetica")
        .text(`Reporte de los diagnósticos`, 0, headerY + 25, {
          align: "center",
        });
      ...
      if (grafico) {
        try {
          ...
          doc
            ...
            .fontSize(12)
            .fillColor(COLORES.texto)
            .text("Distribución de Promedios de Test por Paciente", {
              align: "center",
            });
