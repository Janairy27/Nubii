  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fontSize(15)
        .text("Reporte de seguimiento emocional individual", 0, headerY - 5, {
          align: "center",
        });
      ...
      headers.forEach((header, i) => {
        doc.text(header, startX + getColumnX(i) + 5, startY + 8, {
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fontSize(16)
        .text("Reporte de Seguimiento de Pacientes", 0, headerY - 5, {
          align: "center",
        });
        ...
        try {
          if (typeof Buffer !== "undefined") {
            ...
            doc
              ...
              .fontSize(12)
              .fillColor(COLORES.texto)
              .text("Distribución General de Emociones y Tests", {
                align: "center",
              });
      ...
      datos.forEach((row, index) => {
        ...
        const fecha = new Date(row.fecha_ultimo_test).toLocaleDateString(
          "es-ES"
        );
        const sintomas = row.total_sintomas;
        const promEmocion = Number(row.promedio_intensidad_emocional).toFixed(
          2
        );
        ...
        dataRow.forEach((cell, i) => {
          ...
          doc.text(String(cell.value), columnX + 5, y + textYOffset, {
      ...
      doc.on("pageAdded", () => {
        ...
        doc
          ...
          .fontSize(8)
          .text(
            "Reporte generado automáticamente para uso profesional - Sistema de Seguimiento Emocional",
            40,
            doc.page.height - 30,
            { align: "center", width: doc.page.width - 80 }
          );

        doc.text(`Página ${doc.page.number}`, 40, doc.page.height - 18, {
          align: "center",
