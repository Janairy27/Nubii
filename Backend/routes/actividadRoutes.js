...
import {
  ...
  ActualizarActividad,
  EliminarActividad,
  getActividadesByAttributeProfesional,
  getActividadesByProfesional,
  getActividadesByFilter,
  getActividadByidActividad,
  getActividadesByFilterAdmin,
